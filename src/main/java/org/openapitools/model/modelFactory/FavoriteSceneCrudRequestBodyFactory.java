...
public class FavoriteSceneCrudRequestBodyFactory {
    static FavoriteSceneCrudRequestBodyFactory factoryInstance;
    private FavoriteSceneCrudRequestBodyFactory(){}
    public static FavoriteSceneCrudRequestBodyFactory getFactory(){
        if(factoryInstance==null) factoryInstance=new FavoriteSceneCrudRequestBodyFactory();
    ...
    public Object getUsableInstance(FavoriteSceneCrudRequestBody rawBody, OperationType operation) throws Exception{
        switch(operation){
            case CREATE:
